...
public class GetAllRendezVousQueryHandler : IRequestHandler<GetAllRendezVousQuery, IEnumerable<RendezVousDto>>
{
    ...
    public GetAllRendezVousQueryHandler(IRendezVousRepository rendezVousRepository)
    {
    ...
    {
        var rendezVous = await _rendezVousRepository.GetAllAsync(cancellationToken);
